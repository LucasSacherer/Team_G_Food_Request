...
public class TableCreator {
    ...
    private String defaultMenuItemPath = "/Database2/defaultMenuItems.txt";
    private String defaultNodesPath = "/Database2/defaultNodes.txt";
    ...
    /**
     * Creates the foodRequest.FoodRequest table and adds a few test requests
     */
    public void createFoodRequestTable() {
        try {
            ...
            System.out.println("foodRequest.FoodRequest table created!");
            ...
            statement.executeUpdate("INSERT INTO FOODREQUEST VALUES ('food3','1960-01-01 23:03:20','1960-01-01 23:03:20','type3', 'Food Request','GREST01201', null)");
        } catch (SQLException e) {
            System.out.println("foodRequest.FoodRequest table already exists");
            //e.printStackTrace();
        }
    }
    ...
    public void createFoodOrderTable() {
        try {
            ...
            statement.executeUpdate("INSERT INTO FOODORDER VALUES ('food3','1960-01-01 23:03:20','Pudding')");
            statement.executeUpdate("INSERT INTO FOODORDER VALUES ('food3','1960-01-01 23:03:20','Chicken')");
        } catch (SQLException e) {
